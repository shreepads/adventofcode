...
impl fmt::Display for ZeroScanner {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "ZeroScanner: location {}, {} beacons", self.location, self.beacons.len())
    }
}
...
impl fmt::Display for OtherScanner {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "OtherScanner: location {:?}, {} beacons (first: {}, last: {}), {} rotations",
            self.location, self.beacons.len(), self.beacons[0], self.beacons[self.beacons.len()-1],
